...
class ContentRouter(Transform):
    ...
    def __init__(
        ...
        # freeze each block's compress-vs-passthrough verdict on first sighting.
        # The bounded store shadows the compression cache and is cleared with it.
    ...
    def _worker_request_state(self) -> _ContentRouterRequestState:
        ...
        return _ContentRouterRequestState(
            ...
            skip_kompress=state.skip_kompress,
    ...
    def _runtime_skip_kompress(self) -> bool:
        return self._active_request_state().skip_kompress

    @_runtime_skip_kompress.setter
    def _runtime_skip_kompress(self, value: bool) -> None:
        self._active_request_state().skip_kompress = value
